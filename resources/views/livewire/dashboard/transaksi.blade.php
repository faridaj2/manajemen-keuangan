    ...
    <div class="col-span-12 mt-6" x-data="{ nama: 'Oke' }">
        ...
        <div x-data="{ open: false }">
            <button @click=" open = ! open" x-show="!open" class="btn btn-elevated-rounded-primary w-24 mr-1 mb-2">New
                Pay</button>
            <div class="intro-y col-span-12 lg:col-span-6" x-show="open">
                ...
                <div class="intro-y box p-5">
                    <div>
                        ...
                        <input id="crud-form-1" type="text" class="form-control w-full outline-none border-slate-200"
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" class="datepicker form-control w-56 inline-block border-slate-200 rounded-md" data-single-mode="true">
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            ...
            <table class="table table-report -mt-2" x-data="{tab: 0}">
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr class="intro-x">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a @click="tab = (tab === '0' ? '1' : '0' )"  class="flex items-center mr-3" href="javascript:;" @click="edit = true">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" icon-name="check-square"
                                ...
                                <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#delete-modal-preview"
                                    @click="nama = nama = 'Anjali'" class="flex items-center text-danger"
                    ...
                    <tr x-show="tab === 1">
                        <form action="">
                            ...
                            <td>
                                <input type="text" class="p-1 rounded-md mb-1 border-slate-300">
                                <input type="text" class="p-1 rounded-md border-slate-300">
                            </td>
                            <td>
                                <input type="text" class="p-1 rounded-md border-slate-300">
                            </td>
                            <td>
                                <select name="" id="" class="p-1 pr-8 rounded-md border-slate-300">
                            ...
                            <td>
                                ...
                                <input type="text" class="datepicker w-20 border-slate-200 rounded-md" data-single-mode="true">
                                    
                                
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center mr-3" href="javascript:;" @click="edit = true">
                                         Simpan
                                    </a>
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a @click="tab = 2" class="flex items-center mr-3" href="javascript:;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" icon-name="check-square"
                                        data-lucide="check-square" class="lucide lucide-check-square w-4 h-4 mr-1">
                                ...
                                <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#delete-modal-preview"
                                    @click="nama = nama = 'Farid'" class="flex items-center text-danger"
                                    href="javascript:;" data-tw-toggle="modal"
                                    data-tw-target="#delete-confirmation-modal">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    ...
                    <tr x-show="tab === 2" @click.outside="tab = 0">
                        <form action="">
                            <td>
                                Edit
                            </td>
